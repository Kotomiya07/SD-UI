...
var titles = {
    ...
    "Masked content": "What to put inside the masked area before processing it with SD.",
...
onUiLoaded(function() {
    for (var comp of window.gradio_config.components) {
        if (comp.props.ui_tooltip && comp.props.elem_id) {
            var elem = gradioApp().getElementById(comp.props.elem_id);
            if (elem) {
                elem.title = comp.props.ui_tooltip;
            }
        }
    }
});
